...
public class Course implements Serializable
{
	...
	public Course(String course) {courseTitle=course;}
	public Course() {}
	public String toString() {return "Course:" + courseTitle;}
	public String getCourseTitle() {return courseTitle;}
	public void setCourseTitle(String courseTitle) {this.courseTitle = courseTitle;}
	public int getCredit() {return credit;}
	public void setCredit(int credit) {this.credit = credit;}
	public String watchFile(Vector<CourseFile> file){return "Course files: "+file.toString();}
	public String watchTeacher(Vector<Teacher> teach) {return "There are "+teach.size()+" teachers on this course:"+teach.toString();}
